...
E = st.slider('Ends/ inch', 40, 80, 60)
P = st.slider('Picks/ inch', 40, 80, 60)
FL = st.slider('Float Length: e.g. select 1 for 1/1 plain weave; 2 for 2/1 twill; 3 for 3/1 twill', 1, 3, 2)
